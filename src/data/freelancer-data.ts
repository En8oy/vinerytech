...
export const freelancerData = {
  ...
  hero: {
    ...
    description: "Transformo tareas repetitivas en sistemas inteligentes. Especializado en RPA, integraciones API, web scraping y soluciones cloud que reducen costos operativos hasta un 70%.",
    cta: {
  ...
  portfolio: [
    {
      ...
      description: "Plataforma de comercio electrónico completa con gestión de inventario, pagos integrados y panel de administración",
  ...
  testimonials: [
    {
      ...
      position: "CEO",
      company: "StartupTech",
      content: "Excelente trabajo en nuestra plataforma. Entregó a tiempo y superó nuestras expectativas. El código es limpio y bien documentado.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Profesional y eficiente. Nos ayudó a migrar toda nuestra infraestructura a microservicios. Gran conocimiento técnico.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Transformó completamente nuestra tienda online. Las ventas aumentaron un 40% después del rediseño. Altamente recomendado.",
      rating: 5,
  ...
  faqs: [
    {
      ...
      answer: "Depende del alcance del proyecto. Un sitio web simple puede tomar 2-4 semanas, mientras que una aplicación compleja puede requerir 3-6 meses. Durante la consulta inicial, proporcionaré un timeline detallado."
    },
    {
      question: "¿Trabajas con startups o solo empresas establecidas?",
      answer: "Trabajo con todo tipo de clientes: startups, PYMEs, empresas establecidas y emprendedores individuales. Adapto mis servicios y precios según las necesidades y presupuesto de cada cliente."
    },
    {
      question: "¿Ofreces mantenimiento post-lanzamiento?",
      answer: "Sí, todos los proyectos incluyen 30 días de soporte gratuito post-lanzamiento. Después, ofrezco planes de mantenimiento mensual o soporte por hora según tus necesidades."
    },
    {
      question: "¿Qué tecnologías utilizas?",
      answer: "Me especializo en el stack JavaScript moderno (React, Node.js, TypeScript) pero también trabajo con Python, bases de datos SQL/NoSQL, y servicios cloud como AWS y Vercel."
    },
    {
      question: "¿Puedes trabajar con mi equipo existente?",
      answer: "Absolutamente. Tengo experiencia colaborando con equipos internos, ya sea como desarrollador adicional o como líder técnico. Uso metodologías ágiles y herramientas de colaboración estándar."
    },
    {
      question: "¿Cómo manejas los cambios en el alcance del proyecto?",
      answer: "Los cambios menores están incluidos. Para cambios significativos, proporciono una estimación del impacto en tiempo y costo antes de proceder, asegurando transparencia total."
    }
  ],
  ...
  contact: {
    ...
    timezone: "UTC-5 (EST)",
    availability: "Lun-Vie, 9:00 AM - 6:00 PM EST",
    responseTime: "Respuesta en menos de 2 horas",
    preferredContact: "whatsapp",
    calendly: "https://calendly.com/vinerytech",
    social: {
      linkedin: "https://linkedin.com/company/vinerytech",
      github: "https://github.com/vinerytech",
      twitter: "https://twitter.com/vinerytech",
      website: "https://vinerytech.com"
    }
  },
